...
namespace UnityEngine.GameFoundation.Sample
{
    public class TransactionsSample : MonoBehaviour
    {
        ...
        private void SubscribeToGameFoundationEvents()
        {
            ...
            if (GameFoundationSdk.inventory is null || GameFoundationSdk.transactions is null) return;
        ...
        ///     This transaction uses coins from the wallet as the purchase price, and adds an apple Inventory Item to the
        ///     Inventory Manager.
        /// </summary>
        ...
        ///     This transaction uses coins from the wallet as the purchase price, and adds an orange Inventory Item to the
        ///     Inventory Manager.
        /// </summary>
        ...
        ///     This transaction uses coins from the wallet as the purchase price, and adds a banana Inventory Item to the
        ///     Inventory Manager.
        /// </summary>
        ...
        ///     This transaction uses coins from the wallet as the purchase price, and adds a broccoli Inventory Item to the
        ///     Inventory Manager.
        /// </summary>
        ...
        ///     This transaction uses coins from the wallet as the purchase price, and adds a carrot Inventory Item to the
        ///     Inventory Manager.
        /// </summary>
        ...
        ///     TransactionManager will find instances of each InventoryItem for the fruits that are consumed during the
        ///     transaction.
        /// </summary>
        ...
        ///     TransactionManager will find instances of each InventoryItem for the veggies that are consumed during the
        ///     transaction.
        /// </summary>
        ...
        /// <summary>
        ///     Calls <see cref="O:GameFoundationSdk.transactions.BeginTransaction" /> with the purchase detail of the Transaction
        ///     Item displayed in the button.
        ...
        private IEnumerator ExecuteTransaction(BaseTransaction transaction)
        {
            ...
            using (var deferred = GameFoundationSdk.transactions.BeginTransaction(transaction))
            {
                ...
                foreach (var exchange in deferred.result.payout.products)
                    ...
                    if (exchange is CurrencyExchange currencyExchange)
                        Debug.Log(
                            $"Player was awarded {currencyExchange.amount} of currency '{currencyExchange.currency.displayName}'");
        ...
        private void RefreshUI()
        {
            ...
            foreach (var inventoryItem in m_InventoryItems)
            {
                ...
                var itemName = inventoryItem.definition.key;
        ...
        ///     This parameter will not be used, but must exist so the signature is compatible with the
        ///     inventory callbacks so we can bind it.
        /// </param>
        ...
        {
            Debug.Log("Transaction " + transaction.displayName + " is on step " + currentStep + " out of " +
                      totalSteps);
        }
