...
namespace UnityEngine.GameFoundation.Sample
{
    ...
    public class InventoryWithQuantitySample : MonoBehaviour
    {
        ...
        /// </summary>
        private readonly Dictionary<string, List<InventoryItem>> m_UniqueInventoryItems =
        ...
        public void RemoveAllApples()
        {
            ...
            var apple = GameFoundationSdk.catalog.Find<InventoryItemDefinition>("apple");
            var itemsRemovedCount = GameFoundationSdk.inventory.Delete(apple);
        ...
        ///     This example shows the more complicated way of getting an aggregated list of all items in the
        ///     GameFoundationSdk.inventory.
        ...
        private void RefreshUI()
        {
            ...
            foreach (var itemGroup in m_UniqueInventoryItems)
            {
                ...
                var itemName = itemGroup.Value[0].definition.displayName;
        ...
        private void EnableAllButtons(bool enableFlag = true)
        {
            ...
            foreach (var button in m_AllButtons) button.interactable = enableFlag;
        }
