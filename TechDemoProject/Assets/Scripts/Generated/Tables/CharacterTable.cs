...
{
   public sealed partial class CharacterTable : TableBase<Unit>, ITableUniqueValidate
   {
        ...
        public CharacterTable(Unit[] sortedData)
            : base(sortedData)
        {
        ...
        {
            return new MasterMemory.Meta.MetaTable(typeof(Unit), typeof(CharacterTable), "character",
