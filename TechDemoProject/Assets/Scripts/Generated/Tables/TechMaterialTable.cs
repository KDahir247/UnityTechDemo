...
{
   public sealed partial class TechMaterialTable : TableBase<TechMaterial>, ITableUniqueValidate
   {
        ...
        public TechMaterialTable(TechMaterial[] sortedData)
            : base(sortedData)
        {
        ...
        public static MasterMemory.Meta.MetaTable CreateMetaTable()
        {
            return new MasterMemory.Meta.MetaTable(typeof(TechMaterial), typeof(TechMaterialTable), "material",
                new MasterMemory.Meta.MetaProperty[]
                {
                    ...
                    new MasterMemory.Meta.MetaProperty(typeof(TechMaterial).GetProperty("Address")),
