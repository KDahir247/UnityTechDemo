...
public class MainMenuDocumentQ : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        _titleScreen = _coreElement.Q<VisualElement>("MainMenu_Document");
        _optionScreen = _coreElement.Q<VisualElement>("Option_Document");
        _supportScreen = _coreElement.Q<VisualElement>("Support_Document");
        _newScreen = _coreElement.Q<VisualElement>("News_Document");
