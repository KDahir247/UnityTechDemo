...
namespace Pixelplacement.TweenSystem
{
    public abstract class TweenBase
    {
        ...
        {
            //stop where we are:
            if (Status == Tween.TweenStatus.Stopped) return false;
        ...
        /// <summary>
        ///     Sets the essential properties that all tweens need and should be called from their constructor. If targetInstanceID
        ///     is -1 then this tween won't interrupt tweens of the same type on the same target.
        /// </summary>
        protected void SetEssentials(Tween.TweenType tweenType, int targetInstanceID, float duration, float delay,
            bool obeyTimeScale, AnimationCurve curve, Tween.LoopType loop, Action startCallback,
